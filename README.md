Weather Dashboard is an app that returns current weather data and a five-day forecast for any city. It also allows the user to save up to 8 cities in search history. 
